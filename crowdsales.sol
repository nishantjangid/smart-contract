...
// MY TOKEN CONTRACT
contract NewToken is IERC20, ERC20Mintable,ERC20Pausable  {
    string public name;
...
contract myCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, WhitelistCrowdsale{
    // Track investor contribution
    uint256 public investorMinCap = 2000000000000000; // min 0.002 ether
    uint256 public investorMaxCap = 5000000000000000000; // min 50
    ...
    /*
    * Returns the contribution of specific user
    */
